...
class NuScenesDataset(DatasetTemplate):
    ...
    def create_groundtruth_database(self, used_classes=None, max_sweeps=10, with_cam_gt=False, share_memory=False):
        ...
        # database_save_path = self.root_path / f'gt_database_{max_sweeps}sweeps_withvelo_1_4'
        # database_save_path = self.root_path / f'gt_database_{max_sweeps}sweeps_withvelo_1_8'
        db_info_save_path = self.root_path / f'nuscenes_dbinfos_{max_sweeps}sweeps_withvelo.pkl'
        # db_info_save_path = self.root_path / f'nuscenes_dbinfos_{max_sweeps}sweeps_withvelo_1_4.pkl'
        # db_info_save_path = self.root_path / f'nuscenes_dbinfos_{max_sweeps}sweeps_withvelo_1_8.pkl'
...
def create_nuscenes_info(version, data_path, save_path, max_sweeps=10, with_cam=False):
    ...
    if version == 'v1.0-trainval':
        ...
        # 1/8 subset can be generated by uncomment 474-476, and 509
        # import random
        # random.shuffle(train_scenes)
        # train_scenes = train_scenes[:int(len(train_scenes) * 0.125)] # 1/8 subset
    ...
    if version == 'v1.0-test':
        ...
        # with open(save_path / f'nuscenes_infos_{max_sweeps}sweeps_train_1_8.pkl', 'wb') as f:
            pickle.dump(train_nusc_infos, f)
